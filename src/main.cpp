...
int main(){ 
    backend::MatrixXd phi_solid = -backend::computeSDF_cuboid(n1, n2, backend::Vector2i(4, 4), backend::Vector2i(n1-8, n2-8)) * l;
    backend::MatrixXd phi_fluid = backend::computeSDF_circle(n1, n2, backend::Vector2d((double)n1 / 3, (double)n2 * 0.4), 28.) * l;
    ...
    //sim.run(0.002, 1);
    sim.outputVideo(0.005, 5, 5, 30, "output");
